...
// readPost?.map(a=> console.log(a[2].show))

  // readPost?.map(a=> a[1].map(c=> console.log(c)));
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-3 mt-3">
                  <select className="form-select" value={regionName} onChange={(e) => setRegionName(e.target.value)}>
                    <option value={0}>Visi</option>
                   {region?.map((g) => (<option key={g.id} value={g.id}>{g.title}</option>))}
                  </select>
                 </div>
              </div>
            </div>
